...
return(
    <div className={props.mirrored ? 'waves waves--mirrored' : 'waves'}>
        ...
        <path id="ee-background" fill="#222" fillOpacity="0" pointerEvents="none" d="M0 0h1920v1080H0z"/>
        <defs>
        <linearGradient id="gradient-1" gradientUnits="userSpaceOnUse" x1="923.32" y1="511.849" x2="923.32" y2="1339.854" gradientTransform="matrix(.4885 -.87256 1.55518 .87068 -679.744 881.577)">
            ...
            <stop offset="1" stopColor="#fff" stopOpacity="0.30" />
        </linearGradient>
        </defs>
        <path d="M1940.615 511.851s-342.089 382.417-980.377 367.12C321.95 863.674 146.734 463.18-142.512 1063.92c-289.246 600.742 2154.048 33.375 2155.439 33.375 1.39 0-72.312-586.836-72.312-585.445z" transform="translate(0 129.326)" fill="url(&quot;#gradient-1&quot;)" fillOpacity={props.waveOpacity} stroke="#000" strokeWidth="0" paintOrder="stroke"/>
        </svg>
        ...
        <path d="M1943.396 129.434s-397.713 329.574-999.845 389.37c-602.133 59.796-1094.407 552.07-1094.407 552.07l273.95 59.797s1880.098-41.719 1881.489-41.719c1.39 0-58.406-960.908-61.187-959.518z" fill="url(&quot;#gradient-2&quot;)" fillOpacity={props.waveOpacity * 0.6} stroke="#000" strokeWidth="0" paintOrder="stroke"/>
        </svg>
        ...
        <path d="M1364.731-42.827S938.858 452.577-180.58 367.403C-1300.018 282.226 8.89-101.928 8.89-101.928l1355.841 59.1z" fill="url(&quot;#gradient-3&quot;)" fillOpacity={props.waveOpacity} stroke="#000" strokeWidth="0" paintOrder="fill"/>
        </svg>
    </div>
)}